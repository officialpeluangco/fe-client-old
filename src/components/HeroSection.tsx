...
const HeroSection = () => {
  return (
    <section className='font-inter w-full flex flex-col gap-10 items-center justify-end p-4 h-[540px] pb-[50px] bg-gradient-to-b from-indigo-900 to-slate-100 mx-auto'>
