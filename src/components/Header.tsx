    ...
    return (
        <header
            ...
            <nav className={`flex flex-row items-center gap-2 list-none text-sm ${white && scrollPosition == 0 ? 'text-white' : 'text-black'}`}>
                <li className={`font-inter cursor-pointer ${scrollPosition>0 || white===false ? 'hover:border-black' : 'hover:border-white'}  border-2 border-transparent transition-all py-[5px] px-6 rounded-lg`}>
